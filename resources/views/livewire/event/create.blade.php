            ...
            <div class="card-body">
                ...
                <form wire:submit.prevent='store'>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="event_date" id="eventDate" class="form-control" wire:model.debounce.300ms='event_date'/>
                    </div>
                    ...
                    <div class="avatar avatar-md me-2">
                        <img src="{{ $banner_images->temporaryUrl() }}" alt="Avatar" class="rounded-circle">
                    </div>
                    @endif
                    <x-form.input_field labelname="Upload banner image (957 x 848)" for="banner_images" type="file" wire:model.debounce.300ms='banner_images' />
                    <x-form.button title="Create" type="submit" wire:loading.attr='disabled'  :disabled="$disabled"/>
                </form>
            </div>
        </div>
    </div> 
