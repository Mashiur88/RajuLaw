                    ...
                    @if ($add_input)
                        <div class="card mb-6">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">{{ $update_mode ? 'update' : 'Add' }} Testimonial</h5>
                            </div>
                            <div class="card-body">
                                <form wire:submit.prevent='{{ $update_mode ? 'update' : 'store' }}'>
                                    ...
                                    <x-form.input_field labelname="Profile picture" for="image"
                                        wire:model.debounce.300ms='image' type='file' />
                                    <x-form.input_field labelname="Rating(1-5)" for="rating"
                                        wire:model.debounce.300ms='rating' type="number" />
