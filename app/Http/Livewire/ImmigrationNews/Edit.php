...
class Edit extends Component
{
    ...
    public $page_title = "Edit Immigration News";
    ...
    public function mount($edit_id)
    {
        ...
        $member = ImmigrationNewsModel::find($edit_id);
    ...
    {
        $member_update = ImmigrationNewsModel::find($this->edit_id);
    ...
    {
        return view('livewire.immigration-news.edit')->layout('admin.app');
    }
}
